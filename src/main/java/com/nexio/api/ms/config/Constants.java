...
public final class Constants {
    ...
    public static final String  CLIENT_API_URL_BASE = "https://nexio-stock-service.herokuapp.com";
    public static final String  CLIENT_API_URL = "https://nexio-stock-service.herokuapp.com/api/clients/";
